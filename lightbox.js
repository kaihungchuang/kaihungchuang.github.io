...
(function () {
  ...
  style.textContent = `
    ...
    #lb-prev:hover { background: rgba(50,48,46,0.95); transform: translateY(-50%) scale(1.1); }
    #lb-next:hover { background: rgba(50,48,46,0.95); transform: translateY(-50%) scale(1.1); }
